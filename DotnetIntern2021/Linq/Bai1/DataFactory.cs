...
namespace DotnetIntern2021.Linq.Bai1
{
    class DataFactory
    {
        ...
        {
            new Student(new Class() { Id = 1, Name = "Class A" }, 1, "John Leo", new DateTime(2000, 2, 1), 9.0),
            new Student(new Class() { Id = 2, Name = "Class B" }, 2, "David Kim", new DateTime(2000, 7, 8), 9.5),
